        ...
        <v-col cols="12">
            ...
            <v-card class="mb-3">
                ...
                <v-card-actions>
                    ...
                    <v-btn color="light-blue" @click="generateImageNormalThumbnail('aqua')">サムネイル作成</v-btn>
                    <v-btn color="blue-darken-4" @click="generateImageNormalThumbnail('blue')">サムネイル作成</v-btn>
                    <v-btn variant="flat" color="light-blue" @click="generateImageThumbnail('aqua')">ATLANTICサムネイル作成</v-btn>
                    <v-btn variant="flat" color="blue-darken-4" @click="generateImageThumbnail('blue')">PACIFICサムネイル作成</v-btn>
                </v-card-actions>
            </v-card>
...
const thumbnailImageAtlantiicUrl = ref('/ink-wave/todays_result/thumb_end_ATLANTIC.jpg')
const thumbnailImagePacificUrl = ref('/ink-wave/todays_result/thumb_end_PACIFIC.jpg')
...
const generateImageNormalThumbnail = async (type: string): Promise<Boolean> => {
    ...
    baseImage.onload = () => {
        ...
        if (type == 'blue') {
            ...
            context.value.fillStyle = '#2282AA';
        }
...
const generateImageThumbnail = async (type: string): Promise<Boolean> => {
    ...
    const baseImage = new Image();
    if (type == 'blue') {
        baseImage.src = thumbnailImagePacificUrl.value;
    } else {
        baseImage.src = thumbnailImageAtlantiicUrl.value;
    }
    ...
    baseImage.onload = () => {
        ...
        context.value.font = `bold ${fontSize}px 'Noto Sans JP', sans-serif`;
        context.value.fillStyle = 'white';
        context.value.fillText(dayNo.value, 1038, 220);
